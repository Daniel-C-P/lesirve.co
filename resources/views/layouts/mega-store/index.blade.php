...
$productosDescuentos = Producto::where('en_oferta', true)->limit(5)->get();
...
<head>
  ...
  @endauth
  @include('layouts.mega-store.styles')
  @yield('css')
</head>
...
<body class="bg-light">
  ...
  @include('layouts.mega-store.header')

  @section('content')
  @include('layouts.mega-store.banner')
  @include('layouts.mega-store.descuentos')
  @include('layouts.mega-store.productos')
  @include('layouts.mega-store.seccion-descuentos')
  @show

  @include('layouts.mega-store.footer')

  @include('layouts.mega-store.scripts')
  @yield('js')
</body>
