...
class EtiquetaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.productos.etiqueta.index', compact('etiquetas'))
    ...
    public function create()
    {
        ...
        return view('tenant.productos.etiqueta.create', compact('etiqueta'));
    }
    ...
    public function show($id)
    {
        ...
        return view('tenant.productos.etiqueta.show', compact('etiqueta'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tenant.productos.etiqueta.edit', compact('etiqueta'));
    }
